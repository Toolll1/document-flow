...
public class DocTypeController {
    ...
    @PreAuthorize("hasAuthority('ADMIN') || ((hasAuthority('ADMINCOMPANY') || hasAuthority('USER')) " +
    ...
    @SecurityRequirement(name = "JWT")
    @PostAuthorize("hasAuthority('ADMIN') || ((hasAuthority('ADMINCOMPANY') || hasAuthority('USER'))" +
    ...
    @SecurityRequirement(name = "JWT")
    @PreAuthorize("hasAuthority('ADMIN') || (#docTypeCreateDto.organizationId==#authentication.principal.organization.id && hasAuthority('ADMINCOMPANY'))")
    ...
    @SecurityRequirement(name = "JWT")
    @PreAuthorize("hasAuthority('ADMIN') || (@docTypeServiceImpl.isAllowedType(#docTypeId, #user) && hasAuthority('ADMINCOMPANY'))")
    ...
    @SecurityRequirement(name = "JWT")
    @PreAuthorize("hasAuthority('ADMIN') || (@docTypeServiceImpl.isAllowedTypeAttribute(#docTypeId, #docAttributeId, #user) && hasAuthority('ADMINCOMPANY'))")
