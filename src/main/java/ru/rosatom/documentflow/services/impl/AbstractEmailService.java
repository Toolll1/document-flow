...
public abstract class AbstractEmailService implements EmailService {
    ...
    public void sendDocProcessAgreementMessageForRecipient(DocProcess docProcess) {
        ...
        Map<String, String> messageParams = Map.of(
                "firstName", docProcess.getRecipientUserId().getFirstName(),
        ...
        sendDocProcessMessage(docProcess.getRecipientUserId().getEmail(), substitutor.replace(messageTemplate.getBody()), messageTemplate.getSubject());
    }
